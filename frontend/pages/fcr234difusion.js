...
const Fcr234difusion = () => {
  return (
    <Cajas>
      ...
      <p style={{color:'#F5857A' , marginTop:'16px' }}>Podio difusión</p>

      <Buttons gray1 style={{marginTop:'24px'}}>Consigue más likes</Buttons>
      <Buttons gray1>Consigue más compartidos</Buttons>
      <Buttons gray1>Consigue más reacciones</Buttons>
      <Buttons gray1>Cadena de difusión</Buttons>
      <Buttons gray1>Consigue mas respuestas</Buttons>
