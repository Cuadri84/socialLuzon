...
const Fcr234baile = () => {
  return (
    <Cajas>
      ...
      <p style={{color:'#F5857A' , marginTop:'16px' }} >Baile</p>

      <Buttons gray1 style={{marginTop:'24px'}}>Aprende 5 pasos seguidos</Buttons>
      <Buttons gray1>Challenge tiktok</Buttons>
      <Buttons gray1>Baile entre amigos</Buttons>
      <Buttons gray1>Baile en pareja</Buttons>
      <Buttons gray1>Baile clásico</Buttons>
